...
void	Kick::enactCommand(void)
{
	...
	if (channel == NULL)
		_user.addResponse(_respbldr.buildResponseNum(channel_name, ERR_NOSUCHCHANNEL));
		...
		_user.addResponse(_respbldr.buildResponseNum(is_kicked + " " + channel_name, ERR_USERNOTINCHANNEL));
